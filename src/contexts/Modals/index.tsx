...
const ModalsProvider = ({ children }: IModalsProviderProps) => {
  ...
  const [showModalRegisterUser, setShowModalRegisterUser] = useState<boolean>(false);
  const [showModalLogin, setShowModalLogin] = useState<boolean>(false);
  const [showModalRegisterUserSuccess, setShowModalRegisterUserSuccess] = useState<boolean>(false);
